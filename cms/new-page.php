    ...
    <div>
        <div class="p-6">
            <section class="p-6 dark:bg-gray-800 dark:text-gray-50">
                ...
                <form action="create-page.php?subj=<?php echo urlencode($subject_one['id']); ?>" method="post" class="rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                    <h2 class="text-lg font-medium title-font mb-5">Add Page</h2>
                    ...
                    <div class="relative mb-4">
                        ...
                        <input type="text" id="content" name="content" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                    <div class="relative mb-4">
                        ...
                        <select name="position" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            <?php
                            $page_set = get_all_pages($page_one);
